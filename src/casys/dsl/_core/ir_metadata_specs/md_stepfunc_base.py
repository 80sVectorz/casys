...
MDK_SIGNATURE = MetadataKey[list[str]]('', 'signature', factory=list, doc='The final JITed step function signature')
MDK_SIGNATURE_BUFFERS = MetadataKey[list[str]]('', 'signature_buffers', factory=list, doc='The buffers in the final JITed step function signature')
