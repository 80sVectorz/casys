...
import numpy as np
import numba
import ast, inspect, astpretty
from typing import get_type_hints

from .soa import SOASchema
from .wrappers import SimStepFunc, CaKernel, CaCellType
from ._utils.misc_utils import namespace_canonicalize_modules

class StepFunctionDescriptor:
    """Holds raw step function data, which will be handed off to the pipeline."""

    def __init__(self, wrapped_func: SimStepFunc) -> None:
...
class StepFuncMetadata:
    ...
    cact_nspace: dict[str, CaCellType]
...
class StepFuncPreprocessor:
    ...
    def preprocess(self, desc: StepFunctionDescriptor) -> StepFuncMetadata:
        ...
        cact_nspace = {
            cast(CaCellType,t.__cac_type__).dclass.__qualname__:t.__cac_type__
